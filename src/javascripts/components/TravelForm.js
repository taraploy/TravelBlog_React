...
export function TravelForm() {
    ...
    const { handleSubmit, handleChange, values, errors, setFieldValue } = useFormik({
        ...
        validationSchema,
        onSubmit(values) {
            fetch(`/api/travels${ is_new ? '' : '/' + travel.id }`, {
            ...
            <div className="container">
                <div className="row">
                    <div className="travelForm">
                        ...
                        <h2 className="text-center add-edit-header">{ is_new ? 'Adding a new destination' : 'Editing a destination' }</h2>
                        ...
                        <div className="field mb-3">
                            ...
                            <div className="input-group has-validation is-invalid">
                            <input className={ `form-control ${ errors.poster ? 'is-invalid' : '' }` } type="text" id="poster" name="poster" value={ values.poster } onChange={ handleChange } />
                        ...
                        <div className="field mb-3">
                            ...
                            <div className="input-group has-validation">
                                <textarea rows="4" className={ `form-control ${ errors.info ? 'is-invalid' : '' }` } id="info" name="info" value={ values.info } onChange={ handleChange }></textarea>
                        ...
                        <div className="field mb-3">
                            ...
                            <div className="input-group has-validation">
                                <textarea rows="4" className={ `form-control ${ errors.food ? 'is-invalid' : '' }` } id="food" name="food" value={ values.food } onChange={ handleChange }></textarea>
                        ...
                        <div className="field mb-3">
                            ...
                            <div className="input-group has-validation">
                                <textarea rows="4" className={ `form-control ${ errors.accommodation ? 'is-invalid' : '' }` } id="accommodation" name="accommodation" value={ values.accommodation } onChange={ handleChange }></textarea>
                        ...
                        <div className="field mb-3">
                            ...
                            <div className="input-group has-validation">
                                <textarea rows="4" className={ `form-control ${ errors.activities ? 'is-invalid' : '' }` } id="activities" name="activities" value={ values.activities } onChange={ handleChange }></textarea>
                        ...
                        <div className="field mb-3">
                            ...
                            <div className="input-group has-validation">
                                <textarea rows="4" className={ `form-control ${ errors.transportation ? 'is-invalid' : '' }` } id="transportation" name="transportation" value={ values.transportation } onChange={ handleChange }></textarea>
                        ...
                        <div className="field mb-3">
                            ...
                            <div className="input-group has-validation">
                                <textarea rows="4" className={ `form-control ${ errors.safety ? 'is-invalid' : '' }` } id="safety" name="safety" value={ values.safety } onChange={ handleChange }></textarea>
                        ...
                        <div className="field mb-3">
                            ...
                            <div className="input-group has-validation">
                                <textarea rows="4" className={ `form-control ${ errors.visa ? 'is-invalid' : '' }` } id="visa" name="visa" value={ values.visa } onChange={ handleChange }></textarea>
                        ...
                        <div className="text-center text-md-left">
                            <div className="mb-3">
                                <div className="">
                                    <button className="btn btn-primary submitBtn me-2" type="submit">SUBMIT</button>
                                    <button className="btn btn-secondary cancelBtn" type="button" onClick={ () => is_new ? history.push(`/travels/`) : history.push(`/travels/${ values.id }`) }>CANCEL</button>
                                </div>
                            </div>
                        </div>
                    </form>
